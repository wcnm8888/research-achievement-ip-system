  ...
  try {
    const output = await runAsync(
      ...
      [
        ...
        "--raw",
        "run-code",
        "--filename=tests/acceptance/phase-1/step69g-browser-acceptance.js",
      ],
      { timeout: 240000 },
    );
    try {
...
const main = async () => {
  ...
  dockerCompose(["cp", "tests/acceptance/phase-1/step69g-db-helper.mjs", "api:/app/step69g-db-helper.mjs"]);
